...
% Create results that show all possible structures within a minimal motion
...
Set = cds_settings_defaults(struct('DoF', logical([1 1 1 0 0 1])));
...
Set.general.computing_cluster_max_time = 2.5*3600;
...
Set.structures.use_parallel_rankdef = 6; % higher number for rank loss
...
Set.optimization.optname = sprintf('ARK_3T1R_20220617_structsynthres');
